...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  # PPA
  # They match all the matching characters from left to right.
  # The opposite of this would be requiring all repeating characters
  # to be matched only by literal regexps, and the repeition regexps
  # would only match, going from right to left.
  ...
  # PPA maybe another word for greedy is "impatient."
  # ------------------------------------------------------------------
  ...
  # A character class represents a set of possible matches for each
  # character. Whereas an alternation represents a set of possible matches
  # for groups of characters, or words.
