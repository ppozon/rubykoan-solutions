= Patty Pozon Aguayo's Responses to Ruby Koans

These are my responses to the Ruby Koans, uploaded for version control and 
backup. I've written a Greed Game, which uses rand for dictating the actions of
the players. It is run through the command-line through the regular Ruby Koans
CLI. The game play is shown on the terminal's stdout.

(Thank you to the authors of Ruby Koans, should they ever see this. It was
an unusual and very enjoyable way to learn a new language.)

These ruby files are written on top of the Neo Ruby Koans package, files, and
framework. The Neo Ruby Koans themselves are written by authors Jim Weirich and
Joe O'Brien. They can be downloaded from http://rubykoans.com.

Licensing information:
Ruby Koans is released under a  Creative Commons, Attribution-NonCommercial-ShareAlike License (http://creativecommons.org/licenses/by-nc-sa/3.0/). 

(Following is the original Ruby Koans documentation.)
