...
module Neo
  ...
  module Assertions
    ...
    def assert_equal(expected, actual, msg=nil)
      ...
      # msg ||= "Expected #{expected.inspect} to equal #{actual.inspect}"
      # msg ||= "Expected #{expected.inspect} to equal something else"
  ...
  class Sensei
    ...
    def observe(step)
      if step.passed?
        ...
        @observations << Color.red("#{step.koan_file}##{step.name} And straightway the father of the child cried out, and said with tears, Lord, I believe; help thou mine unbelief.")
        throw :neo_exit
      end
    end
...
# ENDTEXT
    ...
    def encourage
      ...
      puts Color.cyan("   Trust in the LORD with all thine heart; and lean not unto thine own understanding.")
      if ((recents = progress.last(5)) && recents.size == 5 && recents.uniq.size == 1)
        puts Color.cyan("  I can do all things through Christ which strengtheneth me.")
      elsif progress.last(2).size == 2 && progress.last(2).uniq.size == 1
        puts Color.cyan("  For verily I say unto you, That whosoever shall say unto this mountain, Be thou removed, and be thou cast into the sea; and shall not doubt in his heart, but shall believe that those things which he saith shall come to pass; he shall have whatsoever he saith.")
      elsif progress.last.to_i > 0
        puts Color.cyan("  Let your conversation be without covetousness; and be content with such things as ye have: for he hath said, I will never leave thee, nor forsake thee. #{progress.last} completed.")
      end
    end

    def guide_through_error
      puts
      # puts "Above all, taking the shield of faith, wherewith ye shall be able to quench all the fiery darts of the wicked..."
      puts "Like newborn babies, crave pure spiritual milk, so that by it you may grow up in your salvation, now that you have tasted that the Lord is good."
      puts Color.red(indent(failure.message).join)
      puts
      puts "For she said within herself, If I may but touch his garment, I shall be whole."
